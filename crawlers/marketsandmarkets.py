...
def crawl_marketsandmarkets():
    ...
    raw_path = f"data/raw/marketsandmarkets/{today}"
    processed_path = f"data/processed/marketsandmarkets/{today}"
    ...
    driver.quit()
    logger.info(f"Successfully crawled and saved MarketsandMarkets on {today}")
    print("Crawled and saved marketsandmarkets.com ✅")
